...
#open file with filename of web page



#Get Page need o be ina foreach
...
for date in datelist:
    ...
    # We have two membership payments - one the £5 minimum
    ...
    #Snackspace appears twice, I assume the first is income, the second expense, ffs.
